  ...
  return (
    <>
      ...
      >
        ...
        <ul
          className={`flex flex-col gap-4 w-full ease-in-out bg-gris text-black ${
      ...
      <div className="hidden md:flex w-[90%] md:w-[65%] h-14 place-content-center items-center  top-4 rounded-xl shadow-xl  text-black backdrop-blur-xl z-100 bg-navbar">
        <div className="w-full h-full flex  justify-around items-center">
          <div className="h-full flex w-[90%] justify-around py-3  items-center ">
            ...
            <button className="h-[90%] flex">
              <Link to={`/MyProfile/Orders/${1}`}>Pedidos</Link>
            </button>
            <button className="h-[90%] flex">
              <Link to={"/"}>About us</Link>
            </button>
          ...
          <button
            onClick={handleClick}
            className=" h-[90%] flex items-center w-[10%] justify-around"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
            ...
            {/* <div className={` ${isOpen ? "hidden":"flex flex-col bg-gris h-20 z-50"}`}>
