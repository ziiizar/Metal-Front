...
const SpecialOffert = () => {
  ...
  return (
    <section  className="w-full h-[92vh] flex flex-col gap-4 pt-5 items-center ">
      ...
      <div className="relative w-full h-[85vh]  flex place-content-center items-center">
        <ul id="horizontal-scroll" className="overflow-hidden flex gap-4  w-full h-full  text-black pl-4">
