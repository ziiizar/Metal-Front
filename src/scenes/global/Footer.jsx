const Footer = () => {
  return (
    <div className=" lg:grid lg:grid-cols-5 txtw ">
  <div className="relative block h-32 lg:col-span-2 lg:h-full">
    <img
    //   src="https://images.unsplash.com/photo-1642370324100-324b21fab3a9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1548&q=80"
    src="/assets/59d922b8-84b7-41cc-bf35-52a90adc906e.jpg"
      alt=""
      className="absolute inset-0 h-full w-full object-cover"
    />
  </div>

  <div className="px-4  sm:px-6 lg:col-span-3 lg:px-8 flex flex-col justify-between p-4">
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        <p>Llamanos
          {/* <span className="text-xs uppercase tracking-wide text-white">  <svg
        ...
        <ul className="mt-8 space-y-1 text-sm text-white">
          <li>De lunes a viernes: 8am - 5pm</li>
    ...
    <div className="mt-12 border-t border-gray-100 pt-12">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <p className="mt-8 text-xs text-white sm:mt-0">
          &copy; 2022. Metalconf. All rights reserved.
        </p>
      </div>
    </div>
  </div>
